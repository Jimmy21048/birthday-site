    ...
    return (
        <div className="sent">
            ...
            <header>
                ...
                <button popovertarget="menu-popover" className='popover-button' ><i className="fa-solid fa-bars"></i></button>
                <div popover="auto" id='menu-popover'>
                    <button onClick={enableSms}><i class="fa-regular fa-envelope"></i>Feedback</button> 
                    <button onClick={logout}><i class="fa-regular fa-circle-left"></i>Log out</button>
